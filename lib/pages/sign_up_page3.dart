                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text('Bank Information', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 30, fontFamily: 'helvetica'),),
                          ),
                          Padding(
                          ...
                          Padding(
                            ...
                            child: Text('Choose your bank', style: TextStyle(fontSize: 17),),
                          ),
                          Padding(
                          ...
                          Padding(
                            ...
                            child: CheckboxListTile(
                              title: Text('By checking this box you are agreeing to berbera\'s terms and conditions', style: TextStyle(fontSize: 15, color: Colors.grey),),
                          ...
                          Padding(
                              padding: const EdgeInsets.only(left: 28.0, right: 20, top: 10),
                              child: ButtonTheme(
                                height: 50,
                                child: RaisedButton(
