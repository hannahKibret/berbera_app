...
class  InventoryAdd extends StatefulWidget {
  ...
  InventoryAdd({@required this.itemName, @required this.brandName, @required this.category, @required this.price,@required this.qty,@required this.itemDetail, @required this.image});
  @override
                    ...
                    child: TextFormField(
                     ...
                     // onSaved: (String val) => this._profile.contact = val,
                      decoration: InputDecoration(
                        border: OutlineInputBorder(borderRadius:new BorderRadius.circular(8.0)),
                        // helperText: "Optional",
                        labelText: "Item Name",
                      ),
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child:(_image!=null)?ClipRRect(borderRadius: BorderRadius.circular(8.0),child: Image.file(_image,fit:BoxFit.fill)):
                        SizedBox(),
                      ),
                      RaisedButton(
                          color: Colors.white,
